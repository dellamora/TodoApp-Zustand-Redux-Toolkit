...
export const AddTodoForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='text-white items-center flex space-x-2'>
      <input placeholder="Enter a new task..." className="bg-transparent border-#15162c border rounded py-1 px-4" type="text" value={task} onChange={(e) => setTask(e.target.value)} />
      <button  type="submit">
